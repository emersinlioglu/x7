                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option"
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"
                               for="input-sort-order"><?php echo $entry_description; ?></label>
                                    ...
                                    <div class="tab-navigation">
                                        <ul class="nav nav-tabs mainMenuTabs">
                                            ...
                                            <li class="<?php echo $class; ?>"><a
                                                        href="#tab-<?php echo $language['code']; ?>"
                                                        data-toggle="tab"><img
                                                            src="view/image/flags/<?php echo $language['image']; ?>"/></a>
                                            </li>
                                            <?php  $class="";}?>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        <?php $class=" active"; foreach ($languages as $key => $language) { ?>
                                        <div id="tab-<?php echo $language['code']; ?>"
                                             language-id="<?php echo $language['language_id']; ?>"
                                             class="row-fluid tab-pane<?php echo $class; ?> language">
                                            <div>
                                                <textarea language-id="<?php echo $language['language_id']; ?>"
                                                          name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][description]"
                                                          id="description-<?php echo $option_value_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($option_value['option_value_description'][$language['language_id']]) ? $option_value['option_value_description'][$language['language_id']]['description'] : ''; ?></textarea>
                                                <?php $class="";} ?>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript"><!--
        ...
        html += '            </ul>
            ...
            foreach($languages as $language)
            {
                ?
            >
                html += '		<div id="tab-<?php echo $language['
                code
                ']; ?>" language-id="<?php echo $language['
                language_id
                ']; ?>" class="row-fluid tab-pane<?php echo $class; ?> language"><div>';
                html += '			<textarea language-id="<?php echo $language['
                language_id
                ']; ?>" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['
                language_id
                ']; ?>][description]" id="description-<?php echo $option_value_row; ?>-<?php echo $language['
                language_id
