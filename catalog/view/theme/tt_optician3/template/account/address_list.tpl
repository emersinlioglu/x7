  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="buttons clearfix">
        <div class="pull-left"><button onclick="window.location.href='<?php echo $back; ?>'" class="button">
          <span>
            <span>
        ...
        <div class="pull-right"><button onclick="window.location.href='<?php echo $add; ?>'" class="button">
          <span>
            <span>
