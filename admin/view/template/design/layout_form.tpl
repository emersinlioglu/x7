            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <option value="block5" selected="selected"><?php echo $text_block5; ?></option>
                    <?php } else { ?>
                    <option value="block5"><?php echo $text_block5; ?></option>
                    <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="block5"><?php echo $text_block5; ?></option>';
    html += '  </select></td>';
