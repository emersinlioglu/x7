            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ocfeaturedcategorytab" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="input-autoplay" name="autoplay" class="form-control">
                                <option value="0" <?php if($autoplay == 0) { ?> selected="selected" <?php } ?> >No</option>
                                <option value="1" <?php if($autoplay == 1) { ?> selected="selected" <?php } ?> >Yes</option>
                            </select>
                        </div>
                    </div>
