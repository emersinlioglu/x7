          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-additional">
              ...
              <?php
								...
								show_select($modules, 'spec_model', $entry_spec_model, $entry_spec_model_help, array( 	0 => $entry_spec_model_0
...
$('#button-upload').on('click', function() {
	...
	import_upload_timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			//if ( $('#import_delete_before').is(':checked') ) {
			//	form_data.append("import_delete_before", "1");
			//}
...
<script type="text/javascript">
  ...
  function check_for_updates() {
		...
		$.ajax({
			...
			type: 'post',
			data: {module:'ropro', version:'<?php echo $modules['related_options_version']; ?>', lang: '<?php echo $config_admin_language; ?>'},
			dataType: 'json',
