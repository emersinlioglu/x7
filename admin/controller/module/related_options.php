...
class ControllerModuleRelatedOptions extends Controller {
  ...
  public function index() {
    ...
    $data['entry_unavailable_not_required_help'] = $this->language->get('entry_unavailable_not_required_help');
		...
		$data['entry_spec_model_0']    					= $this->language->get('entry_spec_model_0');
		$data['entry_spec_model_1']    					= $this->language->get('entry_spec_model_1');
		$data['entry_spec_model_2']    					= $this->language->get('entry_spec_model_2');
		$data['entry_spec_model_3']    					= $this->language->get('entry_spec_model_3');
    ...
    $data['entry_spec_price_special_help'] 	= $this->language->get('entry_spec_price_special_help');
		...
		$data['entry_import_product_before']		= $this->language->get('entry_import_product_before');
    ...
    $data['entry_ro_variant_name']          = $this->language->get('entry_ro_variant_name');
		$data['entry_ro_sort_order'] 						= $this->language->get('entry_ro_sort_order');
