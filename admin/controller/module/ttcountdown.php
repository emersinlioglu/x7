...
class ControllerModuleTtcountdown extends Controller {
	...
	public function index() {
		...
		$data['entry_thumbslidemode'] = $this->language->get('entry_thumbslidemode');
		...
		if (isset($this->request->post['thumbslidemode'])) {
			$data['thumbslidemode'] = $this->request->post['thumbslidemode'];
		} elseif (!empty($module_info)) {
			$data['thumbslidemode'] = $module_info['thumbslidemode'];
		} else {
			$data['thumbslidemode'] = 'vertical';
		}
