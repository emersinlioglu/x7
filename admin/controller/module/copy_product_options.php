...
class ControllerModuleCopyProductOptions extends Controller {
    ...
    public function index() {
        $this->load->language('module/copy_product_options');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
           ...
           // $this->response->redirect($this->url->link('module/copy_product_options', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $data['action'] = $this->url->link('module/copy_product_options', 'token=' . $this->session->data['token'], 'SSL');
...
//        );
        ...
        $this->response->setOutput($this->load->view('module/copy_product_options.tpl', $data));
    }
